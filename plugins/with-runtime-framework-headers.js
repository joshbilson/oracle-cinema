...
function buildPatch() {
  return [
    ...
    "      if ENV['EXPO_TV'] != '1'",
    "        # Xcode 27 rejects old deployment targets in dependency resource bundles.",
    "        minimum_target = podfile_properties['ios.deploymentTarget'] || '16.4'",
    "        deployment_target = cfg.build_settings['IPHONEOS_DEPLOYMENT_TARGET']",
    "        if deployment_target && Gem::Version.new(deployment_target) < Gem::Version.new(minimum_target)",
    "          cfg.build_settings['IPHONEOS_DEPLOYMENT_TARGET'] = minimum_target",
    "        end",
